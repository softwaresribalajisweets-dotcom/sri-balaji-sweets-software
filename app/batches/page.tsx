...
export default function ItemBatchesPage() {
  ...
  const handleSaveBatch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const qty = Number(manufacturedQuantity);
      ...
      <div className="space-y-6">
        ...
        {isAddModalOpen && (
          <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
            <div className="bg-white w-full max-w-xl rounded-2xl shadow-2xl border border-neutral-200 my-8 overflow-hidden flex flex-col">
              {/* Modal Header */}
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-neutral-500">
                      Generate item batch code with quantity, manufacturing date, and shelf life
                    </p>
                  </div>
                </div>
                <button
              ...
              <form onSubmit={handleSaveBatch} className="flex-1 flex flex-col overflow-hidden">
                <div className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
                  ...
                  {/* 2. Auto-generated Batch Code Badge */}
                ...
                {/* Modal Footer */}
                <div className="p-4 px-6 border-t border-neutral-200 bg-neutral-50 flex items-center justify-between gap-3 rounded-b-2xl">
                  <div className="text-xs text-neutral-600">
                    Total Quantity:{" "}
                    <strong className="font-mono text-neutral-900">
                      {manufacturedQuantity || 0} {selectedItem?.unit || "KG"}
                    </strong>
                  </div>
